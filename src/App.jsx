...
function App() {
  ...
  return (
    <div className=" h-screen w-full flex items-center justify-center p-32 gap-10">
      <div className="w-[40%]">
        <img className=" w-full" src="../public/img.png" alt="img" />
      </div>
      <form className="w-[60%] h-[500px] flex flex-col gap-6 p-16 rounded-md shadow-lg">
          ...
          <div>
            ...
            <div className="absolute font-bold cursor-pointer ">
              <svg
                ...
                viewBox="0 0 24 24"
                stroke="currentColor"
                className="w-6 h-6 ml-[430px] -mt-8"
              >
